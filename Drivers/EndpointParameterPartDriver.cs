...
namespace CSM.WebApi.Drivers
{
    ...
    public class EndpointParameterPartDriver : ContentPartDriver<EndpointParameterPart>
    {
        ...
        {
            return Combined(
                ContentShape("Parts_EndpointParameter", () => shapeHelper.Parts_EndpointParameter(ViewModel: _documentationService.ToViewModel(part))),
                ContentShape("Parts_EndpointParameter_Summary", () => shapeHelper.Parts_EndpointParameter_Summary(ViewModel: _documentationService.ToViewModel(part))),
